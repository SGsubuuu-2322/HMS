      ...
      <div className="relative w-[80%] p-5 shadow-lg shadow-black">
        ...
        <div className="relative z-10 grid auto-rows-min gap-4 md:grid-cols-3 w-full">
          ...
          <div className="bg-[#ffffff88] aspect-video border-2 border-[#0077ff94] rounded-lg flex flex-col items-center justify-around">
            ...
            <NavLink to={"/user/doctors/record"} className="cursor-pointer">
              View ➡️
            </NavLink>
          </div>
          <div className="bg-[#ffffff88] aspect-video border-2 border-[#0077ff94] rounded-lg flex flex-col items-center justify-around">
            ...
            <div className="text-4xl text-red-600 font-bold">1</div>
            <NavLink to={"/user/patients/record"} className="cursor-pointer">
              View ➡️
            </NavLink>
          </div>
          <div className="bg-[#ffffff88] aspect-video border-2 border-[#0077ff94] rounded-lg flex flex-col items-center justify-around">
            ...
            <div className="text-4xl text-red-600 font-bold">1</div>
            <NavLink to={"/user/appointments"} className="cursor-pointer">
              View ➡️
            </NavLink>
          </div>
          <div className="bg-[#ffffff88] aspect-video border-2 border-[#0077ff94] rounded-lg flex flex-col items-center justify-around">
            ...
            <div className="text-4xl text-red-600 font-bold">1</div>
            <NavLink to={"/user/likely/outbreaks"} className="cursor-pointer">
              View ➡️
            </NavLink>
          </div>
          <div className="bg-[#ffffff88] aspect-video border-2 border-[#0077ff94] rounded-lg flex flex-col items-center justify-around">
            ...
            <div className="text-4xl text-red-600 font-bold">1</div>
            <NavLink to={"/user/profile/update"} className="cursor-pointer">
              View ➡️
            </NavLink>
          </div>
          <Skeleton className="aspect-video rounded-xl" />{" "}
